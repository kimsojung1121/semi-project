<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link type="text/css" rel="stylesheet" href="css/users_join_agree.css"/>
...
<div class="content_box">
	<div class="join_agreement_wrap">
		<div class="member_tit">			
			<ol>
				<li class="page_on"><span>01</span> 약관동의<span><img src="https://www.ranicake.com//data/skin/front/jeonyul_200918/img/member/icon_join_step_on.png"></span></li>
		...
		<div class="member_cont">
			<form id="formTerms" name="formTerms" method="post" action="<%=request.getContextPath() %>/home.jsp?workgroup=users&work=users_join">
				...
				<div class="join_agreement_cont">
					<div class="join_agreement_box">
						<div class="form_element">
							...
							<label class="check" id="checkAll" for="allAgree"> IMO CAKE | IMO 케이크의 모든 약관을 확인하고 전체 동의합니다.</label>
...
쇼핑몰 이용약관<br/>
제 1 조 (목적)<br/>
본 약관은 쇼핑몰을 운영하는 주식회사 XXX (이하 ‘회사’라 한다)에서 관련 서비스(이하 ‘서비스’라 하며, 접속 가능한 유,무선 단말기의 종류와 상관없이사이트가 제공하는 모든 서비스를 의미합니다.)를 이용함에 있어 회원의 권리•의무 규정함을 목적으로 합니다.<br/>
<br/>
<br/>
제 2 조 (정의)<br/>
...
<br/>
제 4 조 (약관 외 준칙)<br/>
이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 『전자상거래 등에서의 소비자법률』 등 관련법령의 규정과 일반 상관례에 따릅니다.<br/>
제 5 조 (이용계약의 성립)<br/>
...
8. '회사'는 회원의 상품 배송과정에서 수령인 부재, 주소 및 전화번호 오 입력으로 인하여 수령하지 못하게 될 경우 취소 및 환불은 불가하며, 주소지 변경 또는 재배송시 추가 배송비가 발생됩니다.<br/>
<br/>
<br/>
제 29 조 (분쟁해결)<br/>
...
부칙<br/>
1. 이 약관은 2018년 1월 1일부터 시행합니다.<br/>
2. 이 개정약관은 시행일 이후에 체결되는 계약에만 적용되고 그 이전에 체결된 계약은 개정전의 약관조항을 그대로 적용합니다.
						</div>
						<!-- //agreement_box -->
					</div>
					<!-- //join_agreement_box -->
