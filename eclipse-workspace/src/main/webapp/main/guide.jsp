...
<br />
■ 회원가입안내<br />
	① 저희 IMO CAKE 는 기본적으로는 회원제로 운영하고 있습니다. <br />
	② 회원가입비나 월회비, 연회비등 어떠한 비용도 청구하지 않는 100% 무료 입니다. <br />
	
<br />
 ■ 상품주문방법<br />
	저희 IMO CAKE 에서 상품을 주문하는 방법은 크게 6단계입니다. <br />
	① 상품검색 <br />
	② 쇼핑백에 담기 <br />
	③ 회원ID 로그인  주문 <br />
	④ 주문서 작성 <br />
...
<br />
 ■ 주문확인 및 실시간 배송조회시스템<br />
	IMO CAKE 에서 주문을 하셨을 경우 주문/배송 확인을 통해서 실제 주문이 어떻게 처리되고 있는지 확인 하실 수 있습니다. 회원페이지에서 주문/배송 확인을 클릭해 보세요. <br />
	현재 배송은 OO택배 서비스를 이용하고 있습니다. 본 서비스는 상품 추적을 통해 상품이 어디쯤 도착해 있는지 실시간으로 추적하실 수 있습니다. <br />
<br />
 ■ 안전한 대금 결제 시스템<br />
	저희 IMO CAKE는 무통장 입금과 신용카드의 두 가지 결제방법을 제공하여 드립니다. <br />
...
<br />
 ■ 배송기간 및 배송방법<br />
	...
	저희 IMO CAKE 에서는 구입하신 상품의 배송 방법을 OO택배 서비스를 원칙으로 하고 있습니다. (배송방법은 상품 종류에 따라 상이할 수 있습니다.)<br />
	<br />
 ■ 주문취소, 교환 및 환불<br />
	IMO CAKE 는 소비자의보호를 위해서 규정한 제반 법규를 준수합니다. <br />
