...
<div class="content_box">
	...
	케이크를 업그레이드 하기 위한 연구는 지금도 늘 `ing`입니다.<br> <br> IMO CAKE는 가격 정찰제로, 디자인별 가격을 한 눈에<br> 확인 할 수
	있고, 원하는  케이크를 주문할 수 있습니다.<br><br>
	레터링케이크는 고객과 함께 만들어가는 케이크입니다.<br> 자신이 원하는 레터링을 접수하고, <br> 함께
	새로운 디자인을 협의하며, <br> 자신만의 스토리가 담긴 레터링으로 <br> 더욱 ‘가치있는 케이크’가 완성
	됩니다.<br> <br> 행복한 일을 할 수 있음에 감사합니다.<br> 감사합니다.<br> <br> 
</span>
